...
const numUnfundedOnly = GAMES_JSON.filter ( (game) => {
        return game.goal > game.pledged;
}).length;
...
const displayStr = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${totalGames} games. 
                    Currently, ${numUnfundedOnly} ${numUnfundedOnly >= 2 ? "games remain" : "game remains"} unfunded.
                    We need your help to fund these amazing games!`

// create a new DOM element containing the template string and append it to the description container
const paraElement = document.createElement("p");
paraElement.innerHTML = displayStr;
